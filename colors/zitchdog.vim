...
if s:configuration.style ==# 'night'
  let s:palette = {
        \ 'purple':     ['#a585ed', '141', 'Magenta'],
        \ 'green':      ['#55deaf', '84', 'Green'],
        \ 'cyan':       ['#82e2ff', '117', 'Cyan'],
        \ 'orange':     ['#ffb370', '215', 'Orange'],
        \ 'coral':      ['#ff8791', '210', 'Red'],
        \ 'red':        ['#ff6981', '203', 'Red'],
        \ 'pink':       ['#ff73d6', '212', 'Magenta'],
        \ 'white':      ['#dce0e5', '253', 'White'],
        \ 'gray':       ['#666e82', '242', 'DarkGrey'],
        \ 'ash':        ['#3a3c4e', '237', 'DarkGrey'],
        \ 'black':      ['#1a1b26', '235', 'Black'],
        \ 'mauve':      ['#32344a', '237', 'DarkGrey'],
        \ 'blue':       ['#82aaff', '111', 'Blue'],
        \ 'yellow':     ['#ffdd99', '222', 'Yellow'],
        \ 'magenta':    ['#f29e74', '216', 'Orange'],
        \ 'charcoal':   ['#232433', '236', 'DarkGrey'],
        \ 'slate':      ['#444b6a', '239', 'Grey'],
        \ 'graphite':   ['#5a5c74', '240', 'Grey'],
        \ 'lilac':      ['#c8b4f0', '183', 'Magenta'],
        \ 'amethyst':   ['#a585ed', '141', 'Magenta'],
        \ 'aubergine':  ['#3e3658', '59', 'DarkMagenta'],
        \ 'ebony':      ['#1e1e2e', '235', 'Black'],
        \ 'maroon':     ['#4b2424', '52', 'DarkRed'],
        \ 'pine':       ['#123127', '22', 'DarkGreen'],
        \ 'indigo':     ['#242e58', '17', 'DarkBlue'],
        \ 'umber':      ['#3e2e2e', '52', 'DarkRed'],
        \ 'clay':       ['#4b3b27', '58', 'DarkYellow'],
        \ 'mulberry':   ['#4a243d', '53', 'DarkMagenta'],
        \ 'teal':       ['#1f3e4a', '23', 'DarkCyan'],
        \ 'lightblack': ['#2a2b3d', '237', 'DarkGrey'],
        \ 'darkblack':  ['#0f0f14', '233', 'Black'],
        \ 'none':       ['NONE', 'NONE', 'NONE']
        \ }
endif
...
call s:HL('StatusLine', s:palette.white, s:palette.black)
call s:HL('StatusLineTerm', s:palette.white, s:palette.black)
